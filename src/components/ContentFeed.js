...
const channelID = 'UCISBC7PIksW7h6KbogSuWXw';
    ...
    renderItem(rowData) {
        ...
        return (
            <Card >
                <CardItem>
                    <Left>
                         <Thumbnail source={{ uri: 'https://yt3.ggpht.com/-lcZDoA3st5k/AAAAAAAAAAI/AAAAAAAAAAA/EIOworMN7X8/s100-c-k-no-mo-rj-c0xffffff/photo.jpg' }} />
                        <Body>
                            <TouchableOpacity
